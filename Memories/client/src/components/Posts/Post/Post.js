...
const Post = ({post, setcurrent_id}) => {
     const classes=useStyles();  // Here we destructured props as {post,setcurrent_id}  const classes=useStyles();
     ...
     return (
        ...
        <Typography variant="body2" >{moment(post.createdAt).fromNow()}</Typography>     </div>
